...
public interface INineGridVideoPlayer extends IDragCallback{
     ...
     * 横向全屏模式
     **/
    int MODE_FULL_SCREEN_LANDSCAPE = 11;

    /**
     * 纵向全屏
     */
    int MODE_FULL_SCREEN_PORTRAIT = 12;
    /**
     * 小窗口模式
     **/
    int MODE_TINY_WINDOW = 13;
    ...
    /**
     * 设置播放器控制界面
     * @param controller 播放器控制界面
     */
    void setController(NineGridVideoPlayerController controller);
     ...
     * @param listener 监听器
     */
    void setCustomClickListener(View.OnClickListener listener);

    /**
     * 设置自定义长按监听器
     * @param listener 监听器
     */
    void setCustomLongClickListener(View.OnLongClickListener listener);
     ...
     * @param enable 是否打开音量
     */
    void setVolumeEnable(boolean enable);
